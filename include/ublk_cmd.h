 ...
 *
 *     	It is only used if ublkserver set UBLK_F_NEED_GET_DATA flag
...
/*
 * User should issue io cmd again for write requets to 
 * set io buffer adderss and copy data from bio vectors
